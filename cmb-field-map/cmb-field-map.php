...
Description: Adds <code>pw_map</code> as a feild type to CMB2.  See example usage <a href="https://github.com/mustardBees/cmb_field_map" target="_blank">here</a>
Version: 2.1.2
Author: Phil Wylie
...
class PW_CMB2_Field_Google_Maps {
	...
	public function setup_admin_scripts() {
		wp_register_script( 'pw-google-maps-api', '//maps.googleapis.com/maps/api/js?key=AIzaSyCY2OjocjalQEXiFGCUX7-blaNfZ0qEXZU&libraries=places', null, null );
