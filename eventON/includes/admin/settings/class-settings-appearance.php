		...
		return apply_filters('eventon_appearance_add', 
			array(
				...
				array('id'=>'evcal_font_fam','type'=>'text','name'=>__('Primary Calendar Font family <i>(Note: type the name of the font that is supported in your website. eg. Arial)</i>','eventon')
					...
					array('id'=>'note','type'=>'text','name'=> '<i><b>NOTE:</b> In version 2.5 we have changed our primary font family to Roboto, but we still support the previous font Oswald. Which you can switch to by typing Oswald in above input field.</i>'),
