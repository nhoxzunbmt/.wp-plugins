...
add_filter( 'handle_bulk_actions-upload', 'wpuxss_eml_handle_bulk_actions', 10, 3 );

if ( ! function_exists( 'wpuxss_eml_add_bulk_actions' ) ) {

    function wpuxss_eml_handle_bulk_actions( $redirect_to, $doaction, $post_ids ) {

        if ( $doaction !== 'emlbulkedit' ) {
            return $redirect_to;
        }
